...
struct Balloon2: Identifiable {
    var id = UUID()
    var position: CGPoint
    var size: CGFloat
    var color: String // To differentiate between numbers balloons
}
...
struct LevelThree: View {
    ...
    var body: some View {
        ZStack {Image ("balloongamebackground3")
    ...
    private func addBalloon() {
        ...
        // Randomly select a balloon number from the array
        let balloonColors = ["purple1", "orange2", "greenthree", "blue4", "red5", "yellow6", "purple7", "orange8", "green9", "blue10", "red11", "orange12", "yellow13", "green14", "blue15", "red16", "purple17", "orange18", "red19", "green20"]
